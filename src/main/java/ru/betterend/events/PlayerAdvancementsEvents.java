...
public final class PlayerAdvancementsEvents {
	...
	public static Event<AdvancementComplete> PLAYER_ADVANCEMENT_COMPLETE = EventFactory
			.createArrayBacked(AdvancementComplete.class, callbacks -> (player, advancement, criterionName) -> {
